...
public final class ActionTestUtils {
	...
	private static final class DoSomethingAction<T> implements Action<T> {
		@Override
	...
	private static final class DoSomethingElseAction<T> implements Action<T> {
		@Nullable
		...
		public boolean equals(Object o) {
			...
			DoSomethingElseAction<?> that = (DoSomethingElseAction<?>) o;
			return Objects.equals(what, that.what);
		}

		@Override
		public int hashCode() {
			return Objects.hashCode(what);
		}
